...
VALUES
  (uuid_generate_v4(), 'Depósito Central', 'DEP-001'),
  (uuid_generate_v4(), 'Sucursal Norte', 'DEP-002');

INSERT INTO categories (id, name, description)
VALUES
  (uuid_generate_v4(), 'Electrónica', 'Dispositivos electrónicos'),
  (uuid_generate_v4(), 'Ferretería', 'Herramientas y materiales');

INSERT INTO products (
  id, name, description, warehouse_id, category_id, last_purchase_price, selling_price, stock
)
VALUES
(
  uuid_generate_v4(),
  ...
  (SELECT id FROM warehouses WHERE code = 'DEP-001' LIMIT 1),
...
(
  ...
  (SELECT id FROM warehouses WHERE code = 'DEP-002' LIMIT 1),
